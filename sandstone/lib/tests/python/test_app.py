...
class MainAppTestCase(unittest.TestCase):
    ...
    def test_app_handlers(self):
        ...
        self.assertTrue('/a/filesystem/volumes/%s' in hpaths)
        self.assertTrue('/a/filesystem/volumes/%s/directories/%s/' in hpaths)
        self.assertTrue('/a/filesystem/volumes/%s/files/%s/' in hpaths)
        self.assertTrue('/a/filesystem/volumes/%s/files/%s/contents/' in hpaths)
